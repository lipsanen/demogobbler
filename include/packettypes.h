...
typedef void (*func_demogobbler_handle_packet)(void* client_state, demogobbler_packet *ptr);
...
typedef void (*func_demogobbler_handle_consolecmd)(void* client_state, demogobbler_consolecmd *ptr);
...
typedef void (*func_demogobbler_handle_usercmd)(void* client_state, demogobbler_usercmd *ptr);
...
typedef void (*func_demogobbler_handle_datatables)(void* client_state, demogobbler_datatables *ptr);
...
typedef void (*func_demogobbler_handle_stop)(void* client_state, demogobbler_stop *ptr);
...
typedef void (*func_demogobbler_handle_synctick)(void* client_state, demogobbler_synctick *ptr);
...
typedef void (*func_demogobbler_handle_customdata)(void* client_state, demogobbler_customdata *ptr);
...
typedef void (*func_demogobbler_handle_stringtables)(void* client_state, demogobbler_stringtables *header);
